document.addEventListener('DOMContentLoaded', () => {
  ...
  function generateButtons() {
    const dataDir = 'data/';
    const fileList = ['haneame.json', 'fantasyfactory.json']; // Add your file names here

    // Get the parent element for the buttons
    const cosplayerList = document.getElementById('cosplayer-list');
    cosplayerList.innerHTML = ''; // Clear any existing buttons

    // Create buttons dynamically based on the file list
    fileList.forEach(file => {
      ...
      // Add event listener to load the cosplayer data on click
